...
let startParams = {screen_name: "realDonaldTrump", count: 200}
...
const getTweets = (params) => {
  client.get('statuses/user_timeline', params, function(error, tweets, response) {
    ...
    if (tweetArray.length < 3200) {
      const newParams = {screen_name: "realDonaldTrump", count: 200, max_id: tweetArray[tweetArray.length-1].id_str}
      getTweets(newParams);
    } else {
